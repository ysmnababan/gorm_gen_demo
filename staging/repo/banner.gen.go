...
func newBanner(db *gorm.DB, opts ...gen.DOOption) banner {
	...
	_banner.CreatedBy = field.NewString(tableName, "created_by")
	_banner.ModifiedAt = field.NewInt64(tableName, "modified_at")
	_banner.ModifiedBy = field.NewString(tableName, "modified_by")
	_banner.DeletedAt = field.NewInt64(tableName, "deleted_at")
	_banner.DeletedBy = field.NewString(tableName, "deleted_by")
	_banner.BannerID = field.NewString(tableName, "banner_id")
	_banner.Description = field.NewString(tableName, "description")
	_banner.URLImage = field.NewString(tableName, "url_image")
	_banner.URLRedirect = field.NewString(tableName, "url_redirect")
	_banner.StartDate = field.NewTime(tableName, "start_date")
	_banner.EndDate = field.NewTime(tableName, "end_date")
...
func (b *banner) updateTableName(table string) *banner {
	...
	b.ModifiedAt = field.NewInt64(table, "modified_at")
	...
	b.URLImage = field.NewString(table, "url_image")
	b.URLRedirect = field.NewString(table, "url_redirect")
...
func (b *banner) fillFieldMap() {
	...
	b.fieldMap["url_image"] = b.URLImage
	b.fieldMap["url_redirect"] = b.URLRedirect
