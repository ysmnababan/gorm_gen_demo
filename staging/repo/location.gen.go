...
func newLocation(db *gorm.DB, opts ...gen.DOOption) location {
	...
	_location.CreatedAt = field.NewInt64(tableName, "created_at")
	_location.CreatedBy = field.NewString(tableName, "created_by")
	_location.ModifiedAt = field.NewInt64(tableName, "modified_at")
	_location.ModifiedBy = field.NewString(tableName, "modified_by")
	_location.DeletedAt = field.NewInt64(tableName, "deleted_at")
	_location.DeletedBy = field.NewString(tableName, "deleted_by")
	_location.LocationID = field.NewString(tableName, "location_id")
	_location.LocationName = field.NewString(tableName, "location_name")
	_location.URLImage = field.NewString(tableName, "url_image")
	_location.DirectionGuide = field.NewString(tableName, "direction_guide")
...
func (l *location) updateTableName(table string) *location {
	...
	l.URLImage = field.NewString(table, "url_image")
	l.DirectionGuide = field.NewString(table, "direction_guide")
...
func (l *location) fillFieldMap() {
	...
	l.fieldMap["url_image"] = l.URLImage
	l.fieldMap["direction_guide"] = l.DirectionGuide
}
