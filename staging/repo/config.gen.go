...
func newConfig(db *gorm.DB, opts ...gen.DOOption) config {
	...
	_config.ConfigID = field.NewInt32(tableName, "config_id")
	_config.ConfigCode = field.NewString(tableName, "config_code")
...
func (c *config) updateTableName(table string) *config {
	...
	c.ConfigID = field.NewInt32(table, "config_id")
	c.ConfigCode = field.NewString(table, "config_code")
...
func (c *config) fillFieldMap() {
	...
	c.fieldMap["config_code"] = c.ConfigCode
