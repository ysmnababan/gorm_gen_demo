...
func newNavigation(db *gorm.DB, opts ...gen.DOOption) navigation {
	...
	_navigation.IsPermission = field.NewBool(tableName, "is_permission")
...
func (n *navigation) updateTableName(table string) *navigation {
	...
	n.IsPermission = field.NewBool(table, "is_permission")
...
func (n *navigation) fillFieldMap() {
	...
	n.fieldMap["is_permission"] = n.IsPermission
}
