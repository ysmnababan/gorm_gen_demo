...
func newCustomer(db *gorm.DB, opts ...gen.DOOption) customer {
	...
	_customer.Msisdn = field.NewString(tableName, "msisdn")
	_customer.Password = field.NewString(tableName, "password")
	_customer.URLHeadPic = field.NewString(tableName, "url_head_pic")
	_customer.IsActive = field.NewBool(tableName, "is_active")
	_customer.IsTsel = field.NewBool(tableName, "is_tsel")
	_customer.TselNotifID = field.NewString(tableName, "tsel_notif_id")
...
func (c *customer) updateTableName(table string) *customer {
	...
	c.Msisdn = field.NewString(table, "msisdn")
	c.Password = field.NewString(table, "password")
	c.URLHeadPic = field.NewString(table, "url_head_pic")
	c.IsActive = field.NewBool(table, "is_active")
	c.IsTsel = field.NewBool(table, "is_tsel")
	c.TselNotifID = field.NewString(table, "tsel_notif_id")
...
func (c *customer) fillFieldMap() {
	...
	c.fieldMap["msisdn"] = c.Msisdn
	c.fieldMap["password"] = c.Password
	c.fieldMap["url_head_pic"] = c.URLHeadPic
	c.fieldMap["is_active"] = c.IsActive
	c.fieldMap["is_tsel"] = c.IsTsel
	c.fieldMap["tsel_notif_id"] = c.TselNotifID
}
